...
nesmem2vhd(dumpfilename = "./dmp/lawnmower_ptable.dmp",
              nesmemtype = 1, # Pattern Table
              rom_name = "ROM_PTABLE_LAWN",
              dest_path = "./vhd/"+cpath,
              clk = clk)

nesmem2vhd(dumpfilename = "./dmp/lawnmower_oam_00.dmp",
              nesmemtype = 6, # OAM
...
nesmem2vhdattr(dumpfilename = "./dmp/lawnmower_ntable.dmp",
              rom_name = "ROM_ATABLE_LAWN_00",
              dest_path = "./vhd/"+cpath,
              clk = clk)

nesmem2vhd(dumpfilename = "./dmp/lawnmower_palette.dmp",
...
patterntable2vhdsplit (dumpfilename = "./dmp/lawnmower_ptable.dmp",
                       rom_name = "ROM_PTABLE_LAWN",
                       dest_path = "./vhd/"+cpath,
                       clk = clk)
...
# Total of 2 memories
patterntable2vhdsplit_spr_bg (dumpfilename = "./dmp/lawnmower_ptable.dmp",
                        rom_name = "ROM_PTABLE_LAWN",
                        dest_path = "./vhd/"+cpath,
                        clk = clk)
...
# Total of 4 memories
patterntable2vhdsplit2 (dumpfilename = "./dmp/lawnmower_ptable.dmp",
                        rom_name = "ROM_PTABLE_LAWN",
                        dest_path = "./vhd/"+cpath,
                        clk = clk)
...
nesmem2vhd(dumpfilename = "./dmp/lawnmower_ntable_start.dmp",
              nesmemtype = 0, # Name Table
              rom_name = "ROM_NTABLE_LAWN_START", # Intro screen
              dest_path = "./vhd/"+cpath,
              halfnametable = True,
              clk = clk)

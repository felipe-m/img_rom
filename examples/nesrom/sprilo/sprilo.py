...
nesmem2vhd(dumpfilename = "./dmp/sprilo_ntable_00.dmp",
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_ptable.dmp",
              nesmemtype = 1, # Pattern Table
              rom_name = "ROM_PTABLE_SPRILO",
              dest_path = "./vhd/"+cpath,
              clk = clk)

nesmem2vhd(dumpfilename = "./dmp/sprilo_oam_00.dmp",
              nesmemtype = 6, # OAM
...
nesmem2vhdattr(dumpfilename = "./dmp/sprilo_ntable_00.dmp",
              rom_name = "ROM_ATABLE_SPRILO_00",
              dest_path = "./vhd/"+cpath,
              clk = clk)

nesmem2vhd(dumpfilename = "./dmp/sprilo_palette.dmp",
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_palette2.dmp",
              nesmemtype = 4, # Palette Memory
              rom_name = "ROM_PALETTE_SPRILO",
              dest_path = "./vhd/"+cpath,
              universal_bgcolor = True,
...
patterntable2vhdsplit (dumpfilename = "./dmp/sprilo_ptable.dmp",
                       rom_name = "ROM_PTABLE_SPRILO",
                       dest_path = "./vhd/"+cpath,
                       clk = clk)
...
# Total of 2 memories
patterntable2vhdsplit_spr_bg (dumpfilename = "./dmp/sprilo_ptable.dmp",
                        rom_name = "ROM_PTABLE_SPRILO",
                        dest_path = "./vhd/"+cpath,
                        clk = clk)
...
# Total of 4 memories
patterntable2vhdsplit2 (dumpfilename = "./dmp/sprilo_ptable.dmp",
                        rom_name = "ROM_PTABLE_SPRILO",
                        dest_path = "./vhd/"+cpath,
                        clk = clk)
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_menuscr.bin",
              nesmemtype = 0, # Name Table
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_endscr.bin",
              nesmemtype = 0, # Name Table
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_introscr.bin",
              nesmemtype = 0, # Name Table
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_racet1.bin",
              nesmemtype = 0, # Name Table
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_racet2.bin",
              nesmemtype = 0, # Name Table
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_racet3.bin",
              nesmemtype = 0, # Name Table
...
nesmem2vhd(dumpfilename = "./dmp/sprilo_racet4.bin",
              nesmemtype = 0, # Name Table
